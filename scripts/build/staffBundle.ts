...
const staffRowSchema = z.object({
	...
	name: z.string().trim(),
	dlc: z.optional(z.string().trim()),
	image: z.string().trim(),
	hiringFee: z.coerce.number().int().nonnegative(),
	wageBase: z.coerce.number().int().nonnegative(),
	raise: z.coerce.number(),
	wageMax: z.coerce.number().int().nonnegative(),
	skillLevel3: z.string().trim(),
	cookingBonusLevel3: z.coerce.number().int().nonnegative(),
	servingBonusLevel3: z.coerce.number().int().nonnegative(),
	appealBonusLevel3: z.coerce.number().int().nonnegative(),
	skillLevel7: z.string().trim(),
	cookingBonusLevel7: z.coerce.number().int().nonnegative(),
	servingBonusLevel7: z.coerce.number().int().nonnegative(),
	cookingStatBase: z.coerce.number().int().positive(),
	servingStatBase: z.coerce.number().int().positive(),
	procureStatBase: z.coerce.number().int().positive(),
	appealStatBase: z.coerce.number().int().positive(),
	cookingStatIncrement: z.coerce.number().int().positive(),
	servingStatIncrement: z.coerce.number().int().positive(),
	procureStatIncrement: z.coerce.number().int().positive(),
	appealStatIncrement: z.coerce.number().int().positive(),
	cookingStatMax: z.coerce.number().int().positive(),
	servingStatMax: z.coerce.number().int().positive(),
	procureStatMax: z.coerce.number().int().positive(),
	appealStatMax: z.coerce.number().int().positive(),
	branchStatCalc: z.coerce.number(),
	seasoningsMinLevel20: z.coerce.number().int().positive(),
	seasoningsMaxLevel20: z.coerce.number().int().positive(),
	seasoningsBonus: z.coerce.number().int().nonnegative(),
	branchRankMax: z.coerce.number().int().nonnegative(),
	branchPopularityMax: z.coerce.number().int().nonnegative(),
	branchPopularityMaxAtLevel: optionalNumber

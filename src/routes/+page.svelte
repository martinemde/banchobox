...
<div class="container mx-auto px-4 py-8">
	<div class="mb-12 text-center">
		...
		<p class="text-on-surface-token mx-auto max-w-2xl text-xl">
	...
	<div class="mx-auto grid max-w-6xl gap-8 md:grid-cols-3">
		...
		>
			...
			<button
				type="button"
				class="mt-auto btn w-full preset-filled btn-lg"
				on:click={() => goto('/dishes')}
			>
				View All Dishes
			</button>
	...
	<div class="mt-16 text-center">
		<div class="mx-auto max-w-4xl">
			...
			<p class="text-on-surface-token/75 text-lg leading-relaxed">
				Bancho Box is a comprehensive database for Dave the Diver, featuring detailed information
				about dishes, ingredients, and party events. Whether you're planning the perfect restaurant
				menu or looking for specific ingredients, this tool helps you navigate the depths of Dave's
				culinary world.
			</p>
		</div>
	</div>
